                ...
                <div className="grid grid-cols-1 gap-6">
                  {matches.map((match, index) => (
                    ...
                    >
                        ...
                        <div className="flex items-center">
                          <span
                            className={`px-3 py-1 rounded-full text-sm font-medium ${
                              getMatchLevel(match.score).bgColor
                            } ${getMatchLevel(match.score).textColor}`}
                          >
                            {getMatchLevel(match.score).text} ({match.score}%)
                          </span>
                        </div>
                      </div>
                      <div className="mt-4">
                        <h4 className="text-sm font-medium text-gray-700 mb-2">匹配技能</h4>
                        <div className="flex flex-wrap gap-2">
                          {match.matchingSkills?.map((skill, i) => (
                            <SkillTag key={i} type="match">
                              {skill}
                            </SkillTag>
                          ))}
                        </div>
                      ...
                      <div className="mt-4">
                        <h4 className="text-sm font-medium text-gray-700 mb-2">缺失技能</h4>
                        <div className="flex flex-wrap gap-2">
